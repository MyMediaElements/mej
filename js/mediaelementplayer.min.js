...
! function a(b, c, d) {
            ...
            buildtracks: function(a, b, c, d) {
                if (0 !== a.tracks.length) {
                    ...
                    for (e.options.toggleCaptionsButtonWhenOnlyOne && 1 === l ? a.captionsButton.on("click", function() {
                        ...
                        }), a.trackToLoad = -1, a.selectedTrack = null, a.isLoadingTrack = !1, j = 0; m > j; j++) k = a.tracks[j].kind, ("subtitles" === k || "captions" === k) && a.addTrackButton(a.tracks[j].trackId, a.tracks[j].srclang, a.tracks[j].label);
                ...
                if (void 0 !== this.tracks) {
                    var a = this,
                        ...
                        d = function(a) {
                            ...
                            for (var e = b.getElementsByTagName("*"), f = 0, g = e.length; g > f; f++)
                                for (var h = e[f].attributes, i = Array.prototype.slice.call(h), j = 0, k = i.length; k > j; j++) i[j].name.startsWith("on") || i[j].value.startsWith("javascript") ? e[f].parentNode.removeChild(e[f]) : "style" === i[j].name && e[f].removeAttribute(i[j].name);
                            return b.innerHTML
                        };
                    if (null !== b && b.isLoaded) {
                        if (c = a.searchTrackPosition(b.entries, a.media.currentTime), c > -1) return a.captionsText.html(d(b.entries[c].text)).attr("class", a.options.classPrefix + "captions-text " + (b.entries[c].identifier || "")), void a.captions.show().height(0);
                        a.captions.hide()
    ...
    17: [function(a, b, c) {
            ...
            r = c.PluginDetector = {
                ...
                detectPlugin: function(a, b, c, d) {
                    var f = [0, 0, 0],
                        h = void 0,
                        i = void 0;
                    if (p.IS_EDGE || null === p.NAV.plugins || void 0 === p.NAV.plugins || "object" !== e(p.NAV.plugins[a])) {
                        if (void 0 !== g["default"].ActiveXObject) try {
                            i = new ActiveXObject(c), i && (f = d(i))
                        } catch (j) {}
                    } else if (h = p.NAV.plugins[a].description, h && ("undefined" == typeof p.NAV.mimeTypes || !p.NAV.mimeTypes[b] || p.NAV.mimeTypes[b].enabledPlugin)) {
                        f = h.replace(a, "").replace(/^\s+/, "").replace(/\sr/gi, ".").split(".");
                        for (var k = 0; k < f.length; k++) f[k] = parseInt(f[k].match(/\d+/), 10)
                    }
                    return f
                }
            };
        ...
        if (t) {
            q.typeChecks.push(function(a) {
                return a = a.toLowerCase(), a.startsWith("rtmp") ? a.includes(".mp3") ? "audio/rtmp" : "video/rtmp" : a.includes(".oga") || a.includes(".ogg") ? "audio/ogg" : p.HAS_MSE || p.SUPPORTS_NATIVE_HLS || !a.includes(".m3u8") ? !p.HAS_MSE && a.includes(".mpd") ? "application/dash+xml" : !p.HAS_MSE && a.includes(".flv") ? "video/flv" : null : "application/x-mpegURL"
            });
            var u = {
                name: "flash_video",
                options: {
                ...
                canPlayType: function(a) {
                    return t && ["video/mp4", "video/rtmp", "audio/rtmp", "rtmp/mp4", "audio/mp4"].includes(a) || !p.HAS_MSE && t && ["video/flv", "video/x-flv"].includes(a)
                },
                create: s.create
            };
            n.renderer.add(u);
    ...
    19: [function(a, b, c) {
        ...
        var B = c.SUPPORTS_MEDIA_TAG = void 0 !== y.canPlayType || v,
            C = c.SUPPORTS_NATIVE_HLS = t || o && (r || u) || p && null !== l.match(/edge/gi),
        ...
        var F = void 0 !== y.webkitRequestFullScreen,
            ...
            M = void 0,
            N = void 0;
        G ? J = h["default"].mozFullScreenEnabled : H && (J = h["default"].msFullscreenEnabled), r && (D = !1), I && (F ? K = "webkitfullscreenchange" : G ? K = "mozfullscreenchange" : H && (K = "MSFullscreenChange"), c.isFullScreen = L = function() {
        ...
        c.isFullScreen = L, c.requestFullScreen = M, c.cancelFullScreen = N, j["default"].Features = j["default"].Features || {}, j["default"].Features.isiPad = m, j["default"].Features.isiPhone = n, j["default"].Features.isiOS = j["default"].Features.isiPhone || j["default"].Features.isiPad, j["default"].Features.isAndroid = o, j["default"].Features.isIE = p, j["default"].Features.isEdge = q, j["default"].Features.isChrome = r, j["default"].Features.isFirefox = s, j["default"].Features.isSafari = t, j["default"].Features.isStockAndroid = u, j["default"].Features.hasMSE = v, j["default"].Features.supportsMediaTag = B, j["default"].Features.supportsNativeHLS = C, j["default"].Features.supportsPointerEvents = w, j["default"].Features.hasiOSFullScreen = S, j["default"].Features.hasNativeFullscreen = O, j["default"].Features.hasWebkitNativeFullScreen = P, j["default"].Features.hasMozNativeFullScreen = Q, j["default"].Features.hasMsNativeFullScreen = R, j["default"].Features.hasTrueNativeFullScreen = T, j["default"].Features.nativeFullScreenEnabled = U, j["default"].Features.fullScreenEventName = V, j["default"].Features.isFullScreen = L, j["default"].Features.requestFullScreen = M, j["default"].Features.cancelFullScreen = N
    }, {
        2: 2,
        3: 3,
        6: 6
...
}, {}, [23, 5, 4, 14, 18, 17, 15, 16, 8, 9, 10, 11, 12, 13]); $(function() {
